...
public class ProposeFromMeUnPassedFragment extends BaseFragment implements ApprovementListView {
    ...
    public void initViews(View view) {
        ...
        mApprovementListPresenterImpl.setAddApplyType(HostType.APPROVE_REJECT);
