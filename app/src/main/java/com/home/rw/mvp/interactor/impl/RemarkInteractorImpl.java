...
public class RemarkInteractorImpl implements RemarkInteractor<BaseEntity>{

    @Inject
    public RemarkInteractorImpl(){

    }
    @Override
    public Subscription setRemark(final RequestCallBack<BaseEntity> callback, String userId, String nickname) {
        return RetrofitManager.getInstance(HostType.REMARK).remark(userId,nickname)
