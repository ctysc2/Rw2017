...
public class ModifiUserInfoInteractorImpl implements ModifiUserInfoInteractor<BaseEntity> {

    @Inject
    public ModifiUserInfoInteractorImpl(){


    }
    @Override
    public Subscription modifiUserInfo(final RequestCallBack<BaseEntity> callback, HashMap<String, Object> input) {
        return RetrofitManager.getInstance(HostType.MODIFI_USER_INFO).modifiUserInfo(input)
