...
public class PublishInteractorImpl implements PublishInteractor<BaseEntity> {

    @Inject
    public PublishInteractorImpl(){

    }

    @Override
    public Subscription publish(final RequestCallBack<BaseEntity> callback, HashMap<String, Object> input) {
        return RetrofitManager.getInstance(HostType.TOPIC_PUBLISH).publish(input)
