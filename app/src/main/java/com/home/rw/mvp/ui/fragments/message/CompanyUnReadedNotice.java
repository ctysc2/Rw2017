...
public class CompanyUnReadedNotice extends BaseFragment implements AlertDialogListener,CompanyNoticeView,DelNoticeView {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if(isFirstLoad && isFragmentVisible && isViewCreated){
            ...
            mCompanyNoticePresenterImpl.getCompanyNotice(mCurrentPage,PAGE_SIZE,UNREADED);
            isFirstLoad = false;
        }
    ...
    private void initRecycleView() {
        ...
        mAdapter.setOnItemDeleteListener(new OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                mAlertDialog.show(CompanyUnReadedNotice.this,getString(R.string.noticedelHint1));
            }
        });
    ...
    public int getLayoutId() {
        return R.layout.fragment_company_unreaded_notice;
    }
