...
public class ContactAdapterSelect extends BaseListViewAdapter {
    ...
    public ContactAdapterSelect(Context context, List<ContractAfterEntity> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.cell_contact_select, parent, false);
