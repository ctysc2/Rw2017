...
public class ZanInteractorImpl implements ZanInteractor<BaseEntity> {

    @Inject
    public ZanInteractorImpl(){

    }
    @Override
    public Subscription zan(final RequestCallBack<BaseEntity> callback, String id) {
        return RetrofitManager.getInstance(HostType.ZAN).follow(id)
