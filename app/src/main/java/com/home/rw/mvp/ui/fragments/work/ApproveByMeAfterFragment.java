...
public class ApproveByMeAfterFragment extends BaseFragment implements ApprovementListView{
    ...
    public void initViews(View view) {
        ...
        mApprovementListPresenterImpl.setAddApplyType(HostType.APPROVE_CHECKED);
