...
public class SignInteractorImpl implements SignInteractor<BaseEntity> {
    ...
    @Override
    public Subscription sign(final RequestCallBack<BaseEntity> callback, HashMap<String, Object> input) {
        return RetrofitManager.getInstance(HostType.SIGN).sign(input)
