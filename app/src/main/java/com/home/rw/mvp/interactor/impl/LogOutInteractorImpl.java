...
public class LogOutInteractorImpl implements LogOutInteractor<BaseEntity> {
    ...
    @Override
    public Subscription logOut(final RequestCallBack<BaseEntity> callback) {
        return RetrofitManager.getInstance(HostType.LOGOUT).logOut()
