...
public class FeedBackInteractorImpl implements FeedBackInteractor<BaseEntity>{
    ...
    @Override
    public Subscription sendFeedBack(final RequestCallBack<BaseEntity> callback, int reqType,String content) {
        return RetrofitManager.getInstance(reqType).feedBack(content)
