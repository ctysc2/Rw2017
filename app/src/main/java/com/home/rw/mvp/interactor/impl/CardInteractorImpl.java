...
public class CardInteractorImpl implements CardInteractor<BaseEntity> {
    ...
    @Override
    public Subscription card(final RequestCallBack<BaseEntity> callback, HashMap<String, Object> input) {
        return RetrofitManager.getInstance(HostType.CARD).card(input)
